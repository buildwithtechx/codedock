...
type ServerlessHandler struct {
	serverlessService projectservices.ServerlessService
}

func NewServerlessHandler(serverlessService projectservices.ServerlessService) *ServerlessHandler {
...
func (h *ServerlessHandler) SaveCode(c echo.Context) error {
	...
	return utils.Success(c, "code saved successfully", map[string]any{
		"code": code,
	})
}
...
func (h *ServerlessHandler) GetCode(c echo.Context) error {
	...
	return utils.Success(c, "Code fetched successfully", map[string]any{
		"code": code,
	})
}
