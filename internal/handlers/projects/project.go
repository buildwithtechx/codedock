...
type ProjectHandler struct {
	...
	projectSettingsService *projectservices.ProjectSettingsService
}

func NewProjectHandler(s *projectservices.ProjectService, pss *projectservices.ProjectSettingsService) *ProjectHandler {
