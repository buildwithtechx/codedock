...
func NewServer(db *sql.DB, v *utils.Vault, deployer *engine.Deployer, traefikManager *engine.TraefikManager, dockerClient *client.Client, dataDir string) (*Server, error) {
	...
	environmentHandler := handlers.NewEnvironmentHandler(environmentService, projectService)
	...
	backupHandler := handlers.NewBackupHandler(backupService, appService, databaseService, projectService)
	...
	domainHandler := handlers.NewDomainHandler(environmentService, appService, projectService)
	...
	oneClickHandler := handlers.NewOneClickHandler(oneClickService, projectService)
	archiveService := services.NewArchiveService(appService, deploymentService)
	archiveHandler := handlers.NewArchiveHandler(archiveService, projectService)
	...
	serverMetricsWSHandler := handlers.NewServerMetricsWSHandler(tokenService, serverService)
	serviceLogsWSHandler := handlers.NewServiceLogsWSHandler(tokenService, appService, projectService)
